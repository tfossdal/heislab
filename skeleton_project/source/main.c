...
int main()
{
    ...
    int doors = 0;              // holder styr på dørene

    int good2go = 1;            // skjekker om heisen er klar til å bevege seg

    int goal = -2;              // -2 er satt for at målet ikke skal være lik udefinert etasje
                                // når det ikke finnes noe mål
